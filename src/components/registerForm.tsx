...
const RegisterForm = () => {
  ...
  return (
    <form className="flex flex-col m-5 justify-center items-start" action={formAction}>
      <label htmlFor="name" className="">Name</label>
      <input className="w-full border border-gray-400 rounded-md h-10 p-2 mb-3" type="text" name="name" required placeholder="First Name" />
      <input className="w-full border border-gray-400 rounded-md h-10 p-2 mb-3" type="text" name="name" required placeholder="Middle Name" />
      <input className="w-full border border-gray-400 rounded-md h-10 p-2 mb-3" type="text" name="name" required placeholder="Last Name" />
      ...
      <input className="w-full border border-gray-400 rounded-md h-10 p-2 mb-3" type="password" name="password" required placeholder="Password" />
      <input className="w-full border border-gray-400 rounded-md h-10 p-2 mb-3" type="password" name="password" required placeholder="Repeate the Password" />
